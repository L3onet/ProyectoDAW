...
class Usuario{
    ...
    public function save(){
        $sql = "INSERT INTO usuarios (USUARIO, ID_ROL, NOMBRE, APELLIDO_PATERNO, APELLIDO_MATERNO, ID_ORGANIGRAMA, PASS, ESTADO) VALUES('{$this->getUsuario()}', '{$this->getId_rol()}', '{$this->getNombre()}', '{$this->getApellido_paterno()}', '{$this->getApellido_materno()}', '{$this->getId_organigrama()}', '{$this->getId_pass()}', '1');";
